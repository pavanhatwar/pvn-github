...
with open( 'file.csv','w') as csvfile:
    fieldnames = ['Sr.N', 'Region','Name-Tag', 'InstanceType', 'InstanceId', 'State', 'Timestamp', 'DiskSpaceUtilization']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    dict = {'Sr.N': '', 'Region': '', 'Name-Tag': '', 'InstanceType': '', 'InstanceId': '', 'State': '', 'Timestamp': '',
...
########DiskSpaceUtilization
                ...
                response = client.get_metric_statistics(
                    ...
                    StartTime=datetime(year, month, day) - timedelta(seconds=600),
